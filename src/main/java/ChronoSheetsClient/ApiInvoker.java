...
import ChronoSheetsClient.auth.Authentication;
import ChronoSheetsClient.auth.ApiKeyAuth;
import ChronoSheetsClient.auth.HttpBasicAuth;
import ChronoSheetsClient.request.GetRequest;
import ChronoSheetsClient.request.PostRequest;
import ChronoSheetsClient.request.PutRequest;
import ChronoSheetsClient.request.DeleteRequest;
import ChronoSheetsClient.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("x-chronosheets-auth", new ApiKeyAuth("header", "x-chronosheets-auth"));
