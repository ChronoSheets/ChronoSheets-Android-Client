...
public class GeoFencingApi {
  ...
  */
  public ApiResponseForPaginatedListBasicGeofence geoFencingGetGeofencesBasicInfo (String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'xChronosheetsAuth' is set
    if (xChronosheetsAuth == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xChronosheetsAuth' when calling geoFencingGetGeofencesBasicInfo",
        new ApiException(400, "Missing the required parameter 'xChronosheetsAuth' when calling geoFencingGetGeofencesBasicInfo"));
    }

    // create path and map variables
    String path = "/GeoFencing/GetGeofencesBasicInfo";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (ApiResponseForPaginatedListBasicGeofence) ApiInvoker.deserialize(localVarResponse, "", ApiResponseForPaginatedListBasicGeofence.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param xChronosheetsAuth The ChronoSheets Auth Token
  */
  public void geoFencingGetGeofencesBasicInfo (String xChronosheetsAuth, final Response.Listener<ApiResponseForPaginatedListBasicGeofence> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/GeoFencing/GetGeofencesBasicInfo".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ApiResponseForPaginatedListBasicGeofence) ApiInvoker.deserialize(localVarResponse,  "", ApiResponseForPaginatedListBasicGeofence.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
