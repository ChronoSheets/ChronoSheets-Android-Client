...
public class UsualHoursApi {
  ...
  */
  public ApiResponseListUsualHoursDay usualHoursGetUsualHours (Integer userId, String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (ApiResponseListUsualHoursDay) ApiInvoker.deserialize(localVarResponse, "", ApiResponseListUsualHoursDay.class);
      } else {
         return null;
      }
  ...
  */
  public void usualHoursGetUsualHours (Integer userId, String xChronosheetsAuth, final Response.Listener<ApiResponseListUsualHoursDay> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ApiResponseListUsualHoursDay) ApiInvoker.deserialize(localVarResponse,  "", ApiResponseListUsualHoursDay.class));
  ...
  */
  public ApiResponseBoolean usualHoursSetUsualHours (String xChronosheetsAuth, SetUsualHoursRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Set usual hours (rostered hours) for an employee.  Requires the &#39;ManageOrganisationUsers&#39; permission.
   * 
   * @param xChronosheetsAuth The ChronoSheets Auth Token   * @param request A Set UsualHours Request object containing updated data.  Make sure to specify the Day types in the request object so that ChronoSheets knows which Days to update
  */
  public void usualHoursSetUsualHours (String xChronosheetsAuth, SetUsualHoursRequest request, final Response.Listener<ApiResponseBoolean> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
