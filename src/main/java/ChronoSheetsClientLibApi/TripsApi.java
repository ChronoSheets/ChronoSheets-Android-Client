...
public class TripsApi {
  ...
  */
  public ApiResponseInt32 tripsCreateTrip (String xChronosheetsAuth, CreateTripRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Create a new trip.  Important: create a timesheet record before calling this, passing in the new timesheet record id as a reference.    Requires the &#39;SubmitTimesheets&#39; permission.
   * 
   * @param xChronosheetsAuth The ChronoSheets Auth Token   * @param request A Create Trip Request object containing values for the new Trip to create
  */
  public void tripsCreateTrip (String xChronosheetsAuth, CreateTripRequest request, final Response.Listener<ApiResponseInt32> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
  ...
  */
  public ApiResponseTrip tripsGetMyTripById (Integer tripId, String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void tripsGetMyTripById (Integer tripId, String xChronosheetsAuth, final Response.Listener<ApiResponseTrip> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public ApiResponseForPaginatedListTrip tripsGetMyTrips (Date startDate, Date endDate, String xChronosheetsAuth, Integer skip, Integer take, Integer vehicleId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (ApiResponseForPaginatedListTrip) ApiInvoker.deserialize(localVarResponse, "", ApiResponseForPaginatedListTrip.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void tripsGetMyTrips (Date startDate, Date endDate, String xChronosheetsAuth, Integer skip, Integer take, Integer vehicleId, final Response.Listener<ApiResponseForPaginatedListTrip> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ApiResponseForPaginatedListTrip) ApiInvoker.deserialize(localVarResponse,  "", ApiResponseForPaginatedListTrip.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
