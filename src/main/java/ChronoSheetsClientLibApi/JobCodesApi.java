...
public class JobCodesApi {
  ...
  */
  public ApiResponseInt32 jobCodesCreateJobCode (String xChronosheetsAuth, InsertJobCodeRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    String path = "/JobCodes/CreateJobCode";
   ...
   * Create a job code.    Requires the &#39;ManageJobsAndTask&#39; permission.
   * 
   * @param xChronosheetsAuth The ChronoSheets Auth Token   * @param request An Insert JobCode Request object containing values for the new JobCode to create
  */
  public void jobCodesCreateJobCode (String xChronosheetsAuth, InsertJobCodeRequest request, final Response.Listener<ApiResponseInt32> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
    ...
    // create path and map variables
    String path = "/JobCodes/CreateJobCode".replaceAll("\\{format\\}","json");
  ...
  */
  public ApiResponseBoolean jobCodesDeleteJobCode (Integer jobCodeId, String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // create path and map variables
    String path = "/JobCodes/DeleteJobCode";
  ...
  */
  public void jobCodesDeleteJobCode (Integer jobCodeId, String xChronosheetsAuth, final Response.Listener<ApiResponseBoolean> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/JobCodes/DeleteJobCode".replaceAll("\\{format\\}","json");
  ...
  */
  public ApiResponseJobCode jobCodesGetJobCodeById (Integer jobCodeId, String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'jobCodeId' is set
    if (jobCodeId == null) {
    ...
    // create path and map variables
    String path = "/JobCodes/GetJobCodeById";
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (ApiResponseJobCode) ApiInvoker.deserialize(localVarResponse, "", ApiResponseJobCode.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void jobCodesGetJobCodeById (Integer jobCodeId, String xChronosheetsAuth, final Response.Listener<ApiResponseJobCode> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/JobCodes/GetJobCodeById".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ApiResponseJobCode) ApiInvoker.deserialize(localVarResponse,  "", ApiResponseJobCode.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public ApiResponseListJobCode jobCodesGetJobCodes (String xChronosheetsAuth) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'xChronosheetsAuth' is set
    if (xChronosheetsAuth == null) {
    ...
    // create path and map variables
    String path = "/JobCodes/GetJobCodes";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (ApiResponseListJobCode) ApiInvoker.deserialize(localVarResponse, "", ApiResponseListJobCode.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param xChronosheetsAuth The ChronoSheets Auth Token
  */
  public void jobCodesGetJobCodes (String xChronosheetsAuth, final Response.Listener<ApiResponseListJobCode> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/JobCodes/GetJobCodes".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ApiResponseListJobCode) ApiInvoker.deserialize(localVarResponse,  "", ApiResponseListJobCode.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * 
   ...
   * @return ApiResponseBoolean
  */
  public ApiResponseBoolean jobCodesUpdateJobCode (String xChronosheetsAuth, UpdateJobCodeRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'xChronosheetsAuth' is set
    if (xChronosheetsAuth == null) {
    ...
    // create path and map variables
    String path = "/JobCodes/UpdateJobCode";
   ...
   * Update a job code.    Requires the &#39;ManageJobsAndTask&#39; permission.
   * 
   * @param xChronosheetsAuth The ChronoSheets Auth Token   * @param request A Update JobCode Request object containing updated fields.  Make sure to specify the JobCode Id in the request object so that ChronoSheets knows which JobCode to update
  */
  public void jobCodesUpdateJobCode (String xChronosheetsAuth, UpdateJobCodeRequest request, final Response.Listener<ApiResponseBoolean> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
    ...
    // create path and map variables
    String path = "/JobCodes/UpdateJobCode".replaceAll("\\{format\\}","json");
