...
import ChronoSheetsClientLibModel.TimesheetFileAttachment;
import java.util.*;
...
public class ApiResponseForPaginatedListTimesheetFileAttachment {
  
  @SerializedName("TotalSetCount")
  private Integer totalSetCount = null;
  @SerializedName("Data")
  private List<TimesheetFileAttachment> data = null;
  ...
  public List<TimesheetFileAttachment> getData() {
    return data;
  }
  public void setData(List<TimesheetFileAttachment> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiResponseForPaginatedListTimesheetFileAttachment apiResponseForPaginatedListTimesheetFileAttachment = (ApiResponseForPaginatedListTimesheetFileAttachment) o;
    return (this.totalSetCount == null ? apiResponseForPaginatedListTimesheetFileAttachment.totalSetCount == null : this.totalSetCount.equals(apiResponseForPaginatedListTimesheetFileAttachment.totalSetCount)) &&
        (this.data == null ? apiResponseForPaginatedListTimesheetFileAttachment.data == null : this.data.equals(apiResponseForPaginatedListTimesheetFileAttachment.data)) &&
        (this.status == null ? apiResponseForPaginatedListTimesheetFileAttachment.status == null : this.status.equals(apiResponseForPaginatedListTimesheetFileAttachment.status)) &&
        (this.message == null ? apiResponseForPaginatedListTimesheetFileAttachment.message == null : this.message.equals(apiResponseForPaginatedListTimesheetFileAttachment.message));
  }
  ...
  public String toString()  {
    ...
    sb.append("class ApiResponseForPaginatedListTimesheetFileAttachment {\n");
