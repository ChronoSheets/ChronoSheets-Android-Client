...
public class ApiResponseForPaginatedListBasicGeofence {
  ...
  public boolean equals(Object o) {
    ...
    return (this.totalSetCount == null ? apiResponseForPaginatedListBasicGeofence.totalSetCount == null : this.totalSetCount.equals(apiResponseForPaginatedListBasicGeofence.totalSetCount)) &&
        (this.data == null ? apiResponseForPaginatedListBasicGeofence.data == null : this.data.equals(apiResponseForPaginatedListBasicGeofence.data)) &&
        (this.status == null ? apiResponseForPaginatedListBasicGeofence.status == null : this.status.equals(apiResponseForPaginatedListBasicGeofence.status)) &&
        (this.message == null ? apiResponseForPaginatedListBasicGeofence.message == null : this.message.equals(apiResponseForPaginatedListBasicGeofence.message));
  }
