...
public class CSApiResponseJobCode {
  
  @SerializedName("Data")
  private CSJobCode data = null;
  ...
  public CSJobCode getData() {
    return data;
  }
  public void setData(CSJobCode data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CSApiResponseJobCode apiResponseJobCode = (CSApiResponseJobCode) o;
    return (this.data == null ? apiResponseJobCode.data == null : this.data.equals(apiResponseJobCode.data)) &&
        (this.status == null ? apiResponseJobCode.status == null : this.status.equals(apiResponseJobCode.status)) &&
        (this.message == null ? apiResponseJobCode.message == null : this.message.equals(apiResponseJobCode.message));
  }
  ...
  public String toString()  {
    ...
    sb.append("class CSApiResponseJobCode {\n");
