...
public class CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence {
  ...
  public boolean equals(Object o) {
    ...
    return (this.totalSetCount == null ? apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.totalSetCount == null : this.totalSetCount.equals(apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.totalSetCount)) &&
        (this.data == null ? apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.data == null : this.data.equals(apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.data)) &&
        (this.status == null ? apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.status == null : this.status.equals(apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.status)) &&
        (this.message == null ? apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.message == null : this.message.equals(apiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.message));
  }
