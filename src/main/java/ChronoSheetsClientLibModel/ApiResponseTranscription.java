...
import ChronoSheetsClientLibModel.Transcription;
...
public class ApiResponseTranscription {
  
  @SerializedName("Data")
  private Transcription data = null;
  ...
  public void setData(Transcription data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiResponseTranscription apiResponseTranscription = (ApiResponseTranscription) o;
    return (this.data == null ? apiResponseTranscription.data == null : this.data.equals(apiResponseTranscription.data)) &&
        (this.status == null ? apiResponseTranscription.status == null : this.status.equals(apiResponseTranscription.status)) &&
        (this.message == null ? apiResponseTranscription.message == null : this.message.equals(apiResponseTranscription.message));
  }
  ...
  public String toString()  {
    ...
    sb.append("class ApiResponseTranscription {\n");
